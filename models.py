...
class FCNet(nn.Module):
    def __init__(self, dim, c, units, activation, norm, cfg):
...
class ConvNet(nn.Module):
    def __init__(self, dims, c, units, activation, norm, cfg):
        ...
        self.layers.append(nn.Linear(c_out * h * w, c, bias=True))
